    ...
    <div class="container-xl">
        ...
        <div class="navbar-nav flex-row order-md-last">
            ...
            <div class="d-none d-md-flex">
                ...
                <a href="#" class="nav-link px-0 hide-theme-light" title="Enable light mode" style="display: none;">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="icon">
                        <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
                ...
                <div class="nav-item dropdown d-none d-md-flex me-3">
                    <a href="#" class="nav-link px-0" data-bs-toggle="dropdown" tabindex="-1" aria-label="Show notifications">
                        <x-dashboard.icon.notification/>
                        <span class="badge bg-red"></span>
                    </a>
                    <div class="dropdown-menu dropdown-menu-arrow dropdown-menu-end dropdown-menu-card">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">Güncellemeler</h3>
                            </div>
        ...
        <div class="nav-item dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
                ...
                <div class="dropdown-divider"></div>
                    <a href="{{ route('language.index')}}" class="dropdown-item"><x-dashboard.icon.language width="16" height="16"/> Diller</a>
                    <a href="{{ route('settings.index')}}" class="dropdown-item"><x-dashboard.icon.settings width="16" height="16"/> Ayarlar</a>
