...
<div class="row">
    ...
    <div class="col-md-3 mb-3 p-1">
        ...
        <x-dashboard.site.activity-log :model="App\Models\ServiceTranslation::class" :model-id="$edit->id"/>
    ...
    @push('scripts')
        <script>
            document.addEventListener('DOMContentLoaded', function () {
                initGallerySortable('{{ route('service.gallerysort') }}');
            });
        </script>
    @endpush
