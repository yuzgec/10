...
{!! html()->model($edit)->form('PUT', route('service.update', $edit->id))
    ...
    <div class="col-12 mb-3">
        <div class="card">
            ...
            <div class="card-header">
                <h3 class="card-title">Hizmet Düzenle [{{ $edit->name }}]</h3>
                <div class="card-actions d-flex">
                    ...
                    <div class="p-1">
                        <a href="{{ route('service.detail', [$edit->getCategory->slug, $edit->slug]) }}" target="_blank" class="btn btn-outline-dark" title="{{$edit->name}} - Sayfasını Önizle">
    ...
    <div class="row">
                    ...
                    <div class="tab-content">
                            <div class="tab-pane @if ($loop->first) active show @endif" id="{{$lang->lang}}" role="tabpanel">
                                ...
                                <div class="card">
                                    <div class="card-status-top bg-blue"></div>
                                    <div class="card-body">
                                        <x-dashboard.form.input label='Hizmet Adı' name='name:{{ $lang->lang }}' placeholder="Hizmet Adı Giriniz ({{ $lang->native }})" maxlength="40"/>
        ...
        <div class="col-md-3 mb-3">
            ...
            <x-dashboard.site.activity-log 
                :model="App\Models\ServiceTranslation::class"
                :model-id="$edit->id"
            />
