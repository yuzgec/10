...
@section('content')
    ...
    <div class="container pt-[17.5rem] xl:pt-[17.5rem] lg:pt-[17.5rem] md:pt-[17.5rem] pb-[4.5rem] xl:pb-[7rem] lg:pb-[7rem] md:pb-[7rem]">
        ...
        <div class="xl:w-6/12 lg:w-6/12 w-full flex-[0_0_auto] xl:px-[35px] lg:px-[20px] px-[15px] max-w-full mt-[50px] !relative">
            ...
            <figure class="!rounded-[.4rem] !mb-0"><img class="!rounded-[.4rem]" src="/web-tasarim-ajansi-izmir.jpg" srcset="/web-tasarim-ajansi-izmir.jpg" alt="image"></figure>
        </div>
        ...
        <div class="xl:w-6/12 lg:w-6/12 w-full flex-[0_0_auto] xl:px-[35px] lg:px-[20px] px-[15px] max-w-full mt-[50px] xl:!order-2 lg:!order-2 !relative">
            ...
            <figure class="!rounded-[.4rem] !mb-0"><img class="!rounded-[.4rem]" src="/frontend/img/photos/se4.jpg" srcset="/frontend/img/photos/se4@2x.jpg 2x" alt="image"></figure>
        </div>
        <!--/column -->
        <div class="xl:w-6/12 lg:w-6/12 w-full flex-[0_0_auto] xl:px-[35px] lg:px-[20px] px-[15px] max-w-full mt-[50px]">
