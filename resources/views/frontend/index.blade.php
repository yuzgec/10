        ...
        <div class="container">
            ...
            <div class="flex flex-wrap mx-[-15px] !text-center">
                <div class="md:w-10/12 lg:w-7/12 xl:w-7/12 w-full flex-[0_0_auto] px-[15px] max-w-full !mx-auto !relative">
                    <img src="/frontend/img/svg/doodle5.svg" class="!w-[5rem] absolute hidden xl:block lg:block" data-delay="1800" style="bottom: -60%; right: 10%" alt="İzmir Web Tasarım ve SEO Uzmanı ">
                    <img src="/frontend/img/svg/doodle6.svg" class="!h-[5rem] !absolute hidden xl:block lg:block" data-delay="1800" style="top: -40%; left: -5%" alt="İzmir Web Tasarım ve SEO Uzmanı ">
        ...
        <div  class="container pt-10">
            ...
            <div class="flex flex-wrap mx-[-15px]">
                <div class="lg:w-9/12 xl:w-8/12 xxl:w-7/12 w-full flex-[0_0_auto] px-[15px] max-w-full !mx-auto">
                    <h2 class="!text-[.75rem] !leading-[1.35] uppercase text-[#3f78e0]  !text-center">Blog</h2>
                    <h3 class="text-[calc(1.305rem_+_0.66vw)] font-bold xl:text-[1.8rem] !leading-[1.3] !mb-6 !text-center">Sektör ve firmamıza ait en güncel haberleri buradan okuyabilirsiniz.</h3>
                </div>
            </div>
                                            ...
                                            <div class="card">
                                                ...
                                                <figure class="card-img-top overlay overlay-1 hover-scale group">
                                                    <a href="{{ route('blog.detail', $item->slug) }}" title="{{ $item->name}}">
                                                        <img class="!transition-all !duration-[0.35s] !ease-in-out group-hover:scale-105" src="{{ $item->getFirstMediaUrl('page', 'thumb') }}" alt="{{ $item->name}}">
                                                    </a>
